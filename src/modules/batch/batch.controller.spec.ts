...
describe('BatchController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = moduleRef.get<BatchController>(BatchController);
  });
  ...
  describe('Find', () => {
    ...
    describe('success', () => {
      ...
      it('should find a batch by id', async () => {
        const result = await controller.find(batch.id);
  ...
  describe('List', () => {
    ...
    it('should return a list of active batchs', async () => {
      const result = await controller.list({ status: BatchStatus.ACTIVE });
    ...
    it('should return a list of inactive batchs', async () => {
      const result = await controller.list({ status: BatchStatus.INACTIVE });
  ...
  describe('Update', () => {
    ...
    it('should update a batch', async () => {
      const result = await controller.update(batch.id, updateBatchDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a batch', async () => {
      const result = await controller.delete(batch.id);
